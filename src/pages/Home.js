...
export function Home() {
    return (_jsxs(_Fragment, { children: [_jsx(SEOHead, { title: "WashU SHPE - Society of Hispanic Professional Engineers | Home", description: "Welcome to Washington University in St. Louis SHPE. Empowering the Hispanic community in STEM through mentorship, professional development, and community service. Join our familia!", keywords: "SHPE, WashU, Washington University, Hispanic Engineers, STEM, Engineering, St. Louis, Society of Hispanic Professional Engineers, mentorship, professional development" }), _jsx(Hero, {}), _jsxs("div", { className: "mt-8 sm:mt-10 lg:mt-14 grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 lg:gap-6 items-stretch mb-8 sm:mb-12 px-6 sm:px-12", children: [_jsxs("div", { className: "flex flex-col gap-4 sm:gap-5 justify-center", children: [_jsx(Mission, {}), _jsx(Vision, {})] }), _jsx("div", { className: "flex justify-center lg:justify-end", children: _jsx("div", { className: "rounded-2xl overflow-hidden shadow-lg w-full max-w-none h-64 sm:h-80 lg:h-[420px] xl:h-[480px]", children: _jsx(OptimizedPicture, { webp: conImgWebp, fallback: conImg, alt: "National Convention 2025", className: "w-full h-full object-cover", loading: "lazy" }) }) })] }), _jsx(Values, {}), _jsx(ExploreMore, {}), _jsx(History, {}), _jsx(Contact, {})] }));
}
